...
public class NebulaRod : BaseModFishingRod
{
    public override int Width => 64;
    public override int Height => 64;
    public override int FishingPower => 50;
    public override int BobberProjectile => ModContent.ProjectileType<NebulaBobber>();
    ...
    public override int CraftingIngredient => (ItemID.FragmentNebula);
    public override int CraftingTile => TileID.LunarCraftingStation;
    public override Color LineColor => new Color(255, 225, 250, 1);
    ...
    )
    {
        Texture2D texture = ModContent
            .Request<Texture2D>("MoreFishingRods/Items/Fishing/FishingRods/NebulaRod")
            .Value;
