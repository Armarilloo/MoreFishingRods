...
public class SolarRod : BaseModFishingRod
{
    public override int Width => 64;
    public override int Height => 64;
    public override int FishingPower => 50;
    public override int BobberProjectile => ModContent.ProjectileType<SolarBobber>();
    ...
    public override int CraftingIngredient => (ItemID.FragmentSolar);
    public override int CraftingTile => TileID.LunarCraftingStation;
    public override Color LineColor => new Color(255, 240, 168, 1);
    ...
    )
    {
        Texture2D texture = ModContent
            .Request<Texture2D>("MoreFishingRods/Items/Fishing/FishingRods/SolarRod")
            .Value;
